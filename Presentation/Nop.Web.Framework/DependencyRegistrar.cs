...
namespace Nop.Web.Framework
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<HistoryMoneyService>().As<IHistoryMoneyService>().InstancePerLifetimeScope();
            builder.RegisterType<HistoryCustomerService>().As<IHistoryCustomerService>().InstancePerLifetimeScope();
